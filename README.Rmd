...
* Survey Units: US Survey Ft; Horizontal Datum: US State Plane NAD83 CA Zone 3; Vertical Datum: Conus GEOID12A.

* Survey extent: Scott Creek State Beach inland to Queseria Creek confluence. Most topo points are from the beach to the north marsh area (to the beach)bad signal starting around the PIT antenna). Echosounder points focused on the main channel from the beach (downstream side of Hwy 1 bridge) to Queseria Creek confluence. 
